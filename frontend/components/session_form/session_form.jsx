    ...
    return (
      <div className="login-body">
        <div className="login-logo">
          <a className="login-nav__logo" href="/" aria-label="Democamp">
            <svg viewBox="0 0 100 60" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="democamp-logo-title">
