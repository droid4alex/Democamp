      ...
      <div id="main-content" className="loading__hide  u-hide-focus" data-appearing-on="" data-bucket-url="" data-bucket-id="" tabIndex="-1">
        <section className="project-index__section project-index__section--projects " data-role="project_group content_filter_group" data-projects-display="card" role="region" aria-label="My Projects">
          <header className="centered">
            ...
            <aside className="project-index__toolbar" data-behavior="hide_when_content_filter_active" role="presentation">
              <span className="options-menu" data-behavior="expandable">
                <button name="button" type="button" title="Show options…" className="options-menu__expansion-toggle btn btn--small btn--icon btn--overflow-icon" data-behavior="toggle_expansion_on_click">. . .</button>
              </span>
            </aside>
          </header>
            ...
            <span className="cards--bookmarked" data-role="bookmarked_projects_container grouped_projects_container" data-skip-dividers="true"><article id="bucket_20918070_card" className="card card--project card--project-topic card--playgrounded" data-role="project_group_item project_card content_filterable" data-sortable-name="Making a Podcast" data-sortable-group="M">
              <section className="card__slider" data-role="card_slider">
                <div className="card__slide card__slide-1" data-role="card_slide" data-step="1">
                  <a className="card__link" href="/projects/1">
                    <div className="card__content">
                      <section>
                        <div className="card__filterable-content">
                          <h2 className="card__title flush" title="" data-role="content_filter_text">Example Project: Customer Outreach</h2>
                          <p className="card__description flush" title="" data-role="content_filter_text">Example project details: Ongoing update of our strategic communications</p>
                        </div>
                      </section>
                    </div>
                  </a>
                  <div className="card-settings " data-role="project_settings">
                    <button name="button" type="button" title="Unpin this project…" className="btn btn--small btn--small-icon btn--borderless u-hide-focus btn--pin-icon card__pin card__pin--unbookmark" data-url="/projects/1/edit" data-behavior="load_project_card_actions">Unpin</button>
                    <button name="button" type="button" title="Options for this project…" className="btn btn--small btn--small-icon btn--borderless u-hide-focus btn--overflow-icon-light card-settings__button" data-url="/projects/1/edit" data-behavior="load_project_card_actions">Options</button>
                  </div>
                </div>
