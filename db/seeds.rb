...
todo1 = Todo.create!(title: "Recruitment", status: false, project_id: demoproject1.id, assignee_id: demouser.id, due_date: (DateTime.now() + 2))
todo2 = Todo.create!(title: "Decide on ice cream expenses", status: false, project_id: demoproject1.id, assignee_id: demouser.id, due_date: (DateTime.now() + 3))
todo3 = Todo.create!(title: "Decide on office expenses", status: false, project_id: demoproject2.id, assignee_id: demouser.id, due_date: (DateTime.now() + 4))
todo4 = Todo.create!(title: "Talk with stakeholders who have concerns", status: false, project_id: demoproject1.id, assignee_id: demouser.id, due_date: (DateTime.now() + 6))
todo5 = Todo.create!(title: "Talk with customers", status: false, project_id: demoproject1.id, assignee_id: demouser.id, due_date: (DateTime.now() + 7))
...
todo7 = Todo.create!(title: "Write drafts of letters and memos", status: false, project_id: demoproject1.id, assignee_id: demouser.id, due_date: (DateTime.now() + 13))
todo8 = Todo.create!(title: "Organize public profile", status: false, project_id: demoproject1.id, assignee_id: demouser.id, due_date: (DateTime.now() + 21))
todo9 = Todo.create!(title: "Copy flyers for distribution", status: false, project_id: demoproject2.id, assignee_id: demouser.id, due_date: (DateTime.now() + 22))
